        ...
        try:
            ...
            for path_file in path_files_list:
                ...
                await self.upload_to_github(
                    ...
                    remote_path = f'FlightsData/AerolineasARG/{Path(path_file).name}', 
...
# ---------- Proccess & Export Data ----------
    ...
    async def export_data(self) -> List[str]:
        table_list = [
            "flight_sections",
            "flights_calendar",
            "price_stats"
            #"airports", Not Necessary Export
            #"price_history_calendar" -> The file exceeds the max size allowed by GitHub
        ]
        ...
        for table in table_list:
            ...
            path_files_list.append(path_file)
